...
contract MockVrfCoordinator is IVRFV2PlusCoordinator {
    ...
    function requestRandomWords(RandomWordsRequest calldata) external returns (uint256 requestId) { requestId = nextRequestId++; consumerForRequest[requestId] = msg.sender; }
