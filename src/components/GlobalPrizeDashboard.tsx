  ...
  return (
    <section className="global-prizes panel" aria-labelledby="global-prize-title">
      ...
      <div className="global-prize-grid">
        <div className="global-total jackpot-total"><span>Global jackpot</span><small>All networks combined</small><strong>{data ? display(data.jackpot) : 'Loading…'} <em>USDT</em></strong><div className="prize-divider" aria-hidden="true" /><p className="prize-copy">Combined live jackpot across all 6 networks</p></div>
        <div className="trophy-column"><TrophyMark /></div>
        <div className="weekly-total"><span>This week’s prizes</span><small>All networks</small><strong>{data ? display(data.weekly) : 'Loading…'} <em>USDT</em></strong><div className="prize-divider" aria-hidden="true" /><p className="prize-copy">Combined current weekly prize pools across all 6 networks</p></div>
