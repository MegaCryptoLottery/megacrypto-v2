  ...
  return (
    <section className="global-prizes panel" aria-labelledby="global-prize-title">
      ...
      <div className="global-prize-grid">
        ...
        <div className="weekly-total"><div className="trophy" aria-hidden="true">⌁</div><span>This week’s prizes</span><small>All networks</small><strong>{data ? `$${display(data.weekly)}` : 'Loading…'} <em>USDT</em></strong></div>
